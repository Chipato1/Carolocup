...
// Conversions between SL_Bus_PI_Laengsregler_std_msgs_Bool and std_msgs::Bool

void convertFromBus(std_msgs::Bool* msgPtr, SL_Bus_PI_Laengsregler_std_msgs_Bool const* busPtr)
{
...
void convertToBus(SL_Bus_PI_Laengsregler_std_msgs_Bool* busPtr, std_msgs::Bool const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Bool");
