...
typedef struct {
  ...
  real_T currPose[3];
  real_T b;
  B_EnabledSubsystem_Stanley_Qu_T EnabledSubsystem_p;/* '<S4>/Enabled Subsystem' */
...
typedef struct {
  ...
  ros_slros_internal_block_Subs_T obj_e;/* '<S3>/SourceBlock' */
...
struct P_Stanley_Querregler_T_ {
  ...
  real_T Gain1_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  P_EnabledSubsystem_Stanley_Qu_T EnabledSubsystem_p;/* '<S4>/Enabled Subsystem' */
