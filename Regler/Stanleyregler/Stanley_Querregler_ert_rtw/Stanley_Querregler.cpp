...
void Stanley_Querregler_step(void)
{
  ...
  b_varargout_1 = Sub_Stanley_Querregler_65.getLatestMessage(&b_varargout_2);
  ...
  rtb_BusAssignment.Data = static_cast<real32_T>
    ((Stanley_Querregler_P.Gain1_Gain * rtb_Product1));
...
void Stanley_Querregler_initialize(void)
{
...

  {
    ...
    tmp_1[18] = '\x00';
    Sub_Stanley_Querregler_65.createSubscriber(tmp_1, 1);
    ...
    tmp_0[12] = '\x00';
    Sub_Stanley_Querregler_66.createSubscriber(tmp_0, 1);
