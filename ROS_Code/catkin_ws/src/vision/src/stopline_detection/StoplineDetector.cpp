...
StoplineDetector::StoplineDetector(std::map<std::string, std::string> config)
{
...
double StoplineDetector::getYDistanceBetweenPoints(Point p1, Point p2) {
...
//call by reference
double StoplineDetector::detect(vector<Vec4i> lines) {
