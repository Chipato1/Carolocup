...
{
  switch (/*übergabeparameter*/)
  {
    case '': digitalWrite(brake_light,ON); 
      break;
    
    case '': digitalWrite(brake_light,Off); 
      break;
      
    case '': digitalWrite(flasher_right,ON);  
      break;
      
    case '': digitalWrite(flasher_right,Off);  
      break;
                 
    case '': digitalWrite(flasher_left,ON);   
       break;
              
    case '': digitalWrite(flasher_left,Off);  
       break; 
    
    case '': digitalWrite(reversing_light,ON); 
      break;
    
    case '': digitalWrite(reversing_light,Off); 
      break;
